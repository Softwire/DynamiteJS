const RETALIATE_TO_DYNAMITE_WITH_WATERBALLOON_PROBABILITY = 0.6;

const USE_DYNAMITE_AFTER_DRAW_PROBABILITY = 0;
const MAKE_RANDOM_MOVE_AFTER_DRAW_PROBABILITY = 0;
